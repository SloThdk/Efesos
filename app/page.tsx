...
const featuredImages = ["/images/photo2.jpg", "/images/photo7.jpg", "/images/photo12.jpg"];
const featuredPrices = ["245,-", "159,-", "139,-"];
...
export default function HomePage() {
  ...
  return (
    <main>
      ...
      ───────────────────────────────────────── */}
      <section style={{
        position: "relative", height: "100vh", minHeight: 580,
        overflow: "hidden", display: "flex", alignItems: "center", justifyContent: "center",
      }}>
        <Image src="/images/photo1.jpg" alt="Blåvand strand" fill priority
          style={{ objectFit: "cover", objectPosition: "center 60%" }} />
        <div style={{
          position: "absolute", inset: 0,
          background: "linear-gradient(160deg, rgba(15,11,6,0.5) 0%, rgba(15,11,6,0.72) 55%, rgba(15,11,6,0.88) 100%)",
        }} />
        ...
        <div style={{ position: "relative", zIndex: 1, textAlign: "center", padding: "0 24px", maxWidth: 780 }}>
          <div className="fade-up delay-1" style={{
            ...
            padding: "6px 18px", border: "1px solid rgba(201,168,76,0.5)",
            borderRadius: 100, color: "var(--ef-gold)",
          ...
          <h1 className="fade-up delay-2" style={{
            ...
            fontSize: "clamp(52px, 9vw, 96px)", fontWeight: 600,
            color: "#fff", lineHeight: 1.0, marginBottom: 22, letterSpacing: "-0.01em",
          }}>
          ...
          <p className="fade-up delay-3" style={{
            fontSize: "clamp(15px, 2vw, 18px)", color: "rgba(255,255,255,0.80)",
            marginBottom: 38, lineHeight: 1.65, whiteSpace: "pre-line",
          }}>
          ...
          <div className="fade-up delay-4" style={{ display: "flex", gap: 14, justifyContent: "center", flexWrap: "wrap" }}>
            <Link href="/menu" prefetch={false} className="btn-hover" style={{
              padding: "15px 36px", backgroundColor: "var(--ef-orange)",
            ...
            <a href="tel:+4575275722" className="btn-ghost-hover" style={{
              padding: "15px 36px", backgroundColor: "transparent",
              ...
              <AnimateIn key={i} delay={i * 90} direction="up">
                <div className="feature-card" style={{
                  ...
                  <div style={{
                    ...
                    backgroundColor: "rgba(200,89,30,0.12)", marginBottom: 18,
                  }}>
                    <Icon size={34} color="var(--ef-orange)" />
                  </div>
                  <h3 style={{ fontFamily: "var(--font-heading)", fontSize: 22, fontWeight: 600, color: "#fff", marginBottom: 8, lineHeight: 1.2 }}>
                    {tx(item.title, lang)}
                  </h3>
      ...
      {/* ─────────────────────────────────────────
          PHOTO SLIDESHOW
      ───────────────────────────────────────── */}
      <section style={{ backgroundColor: "var(--ef-stone)", padding: "80px 24px" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <AnimateIn direction="up">
            <div style={{ textAlign: "center", marginBottom: 44 }}>
              <p style={{ fontSize: 12, letterSpacing: "0.16em", textTransform: "uppercase", color: "var(--ef-orange)", marginBottom: 12 }}>
                {tx(t.gallery.eyebrow, lang)}
              </p>
              <h2 style={{ fontFamily: "var(--font-heading)", fontSize: "clamp(30px, 5vw, 52px)", fontWeight: 600, color: "var(--ef-text)", lineHeight: 1.1 }}>
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <AnimateIn direction="up">
            <div style={{ textAlign: "center", marginBottom: 52 }}>
              <p style={{ fontSize: 12, letterSpacing: "0.14em", textTransform: "uppercase", color: "var(--ef-orange)", marginBottom: 12 }}>
                {tx(t.featured.eyebrow, lang)}
              </p>
              <h2 style={{ fontFamily: "var(--font-heading)", fontSize: "clamp(30px, 5vw, 48px)", fontWeight: 600, color: "var(--ef-text)" }}>
              ...
              <AnimateIn key={i} delay={i * 100} direction="up">
                <div className="card-hover" style={{
                  ...
                  <div style={{ position: "relative", height: 200, overflow: "hidden" }}>
                    <Image src={featuredImages[i]} alt={tx(item.name, lang)} fill
                      style={{ objectFit: "cover", transition: "transform 0.5s ease" }}
                      className="card-img" />
                  </div>
                  <div style={{ padding: "20px 22px 24px" }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 8 }}>
                      <h3 style={{ fontFamily: "var(--font-heading)", fontSize: 22, fontWeight: 600, color: "var(--ef-text)" }}>
                        {tx(item.name, lang)}
                      </h3>
                      <span style={{ fontSize: 17, fontWeight: 700, color: "var(--ef-orange)", flexShrink: 0, marginLeft: 8, fontVariantNumeric: "tabular-nums" }}>
                        {featuredPrices[i]}
                      </span>
                    </div>
      ...
      <section style={{
        ...
        backgroundColor: "var(--ef-dark2)", padding: "96px 24px", textAlign: "center",
      }}>
        <div style={{
          position: "absolute", inset: 0,
        ...
        <AnimateIn direction="up" style={{ position: "relative", zIndex: 1 }}>
          <h2 style={{
            fontFamily: "var(--font-heading)",
            fontSize: "clamp(34px, 5vw, 60px)", fontWeight: 600,
          ...
          <div style={{ display: "flex", gap: 14, justifyContent: "center", flexWrap: "wrap" }}>
            <a href="tel:+4575275722" className="btn-hover" style={{
              padding: "14px 38px", backgroundColor: "var(--ef-orange)",
            ...
            <Link href="/kontakt" prefetch={false} className="btn-ghost-hover" style={{
              padding: "14px 38px", border: "1.5px solid rgba(255,255,255,0.35)",
              color: "#fff", borderRadius: 8, fontWeight: 500, fontSize: 16,
